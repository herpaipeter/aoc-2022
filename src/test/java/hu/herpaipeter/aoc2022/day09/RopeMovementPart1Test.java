...
public class RopeMovementPart1Test {
    ...
    void no_move_should_everything_stay_in_place() {
        ...
        assertEquals(ElfPoint.origo(), ropeMovement.getTailPosition());
    ...
    void same_position_head_two_right_should_followed_by_tail() {
        ...
        assertEquals(new ElfPoint(0,1), ropeMovement.getTailPosition());
        assertEquals(List.of(ElfPoint.origo(), new ElfPoint(0,1)), ropeMovement.getTailRoute());
    }
    ...
    void same_position_head_two_up_should_followed_by_tail() {
        ...
        assertEquals(new ElfPoint(2,0), ropeMovement.getHeadPosition());
        assertEquals(new ElfPoint(1,0), ropeMovement.getTailPosition());
        assertEquals(List.of(ElfPoint.origo(), new ElfPoint(1,0)), ropeMovement.getTailRoute());
    }

    @Test
    void head_moves_up_to_diagonal_touching_tail_should_stay() {
        RopeMovement ropeMovement = new RopeMovement(new ElfPoint(0,1), ElfPoint.origo());
        ropeMovement.move(new Motion(Direction.Up, 1));
        assertEquals(new ElfPoint(1,1), ropeMovement.getHeadPosition());
        assertEquals(ElfPoint.origo(), ropeMovement.getTailPosition());
        assertEquals(List.of(ElfPoint.origo()), ropeMovement.getTailRoute());
    }
    ...
    void head_moves_to_right_diagonal_touching_tail_should_stay() {
        RopeMovement ropeMovement = new RopeMovement(new ElfPoint(1,0), ElfPoint.origo());
        ropeMovement.move(new Motion(Direction.Right, 1));
        assertEquals(new ElfPoint(1,1), ropeMovement.getHeadPosition());
        assertEquals(ElfPoint.origo(), ropeMovement.getTailPosition());
        assertEquals(List.of(ElfPoint.origo()), ropeMovement.getTailRoute());
    ...
    void head_moves_from_diagonal_touching_to_right_tail_should_follow() {
        RopeMovement ropeMovement = new RopeMovement(new ElfPoint(1,1), ElfPoint.origo());
        ropeMovement.move(new Motion(Direction.Right, 1));
        assertEquals(new ElfPoint(1,2), ropeMovement.getHeadPosition());
        assertEquals(new ElfPoint(1,1), ropeMovement.getTailPosition());
        assertEquals(List.of(ElfPoint.origo(), new ElfPoint(1,1)), ropeMovement.getTailRoute());
    }
    ...
    void head_moves_from_diagonal_touching_to_up_tail_should_follow() {
        RopeMovement ropeMovement = new RopeMovement(new ElfPoint(1,1), ElfPoint.origo());
        ropeMovement.move(new Motion(Direction.Up, 1));
        assertEquals(new ElfPoint(2,1), ropeMovement.getHeadPosition());
        assertEquals(new ElfPoint(1,1), ropeMovement.getTailPosition());
        assertEquals(List.of(ElfPoint.origo(), new ElfPoint(1,1)), ropeMovement.getTailRoute());
    }
    ...
    void move_up_by_string_command() {
        ...
        assertEquals(new ElfPoint(1, 0), ropeMovement.getHeadPosition());
    }
    ...
    void sample_test() {
        ...
        assertEquals(new ElfPoint(2, 2), ropeMovement.getHeadPosition());
        assertEquals(new ElfPoint(2, 1), ropeMovement.getTailPosition());
