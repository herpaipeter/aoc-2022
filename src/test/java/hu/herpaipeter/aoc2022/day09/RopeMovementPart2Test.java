...
public class RopeMovementPart2Test {
    ...
    void knots_3_no_move_should_everything_stay_in_place() {
        ...
        assertEquals(Point.origo(), ropeMovement.getKnotPosition(1));
        assertEquals(Point.origo(), ropeMovement.getKnotPosition(2));
    ...
    void move_2_right_should_move_head_and_first_knot() {
        ...
        assertEquals(new Point(0, 1), ropeMovement.getKnotPosition(1));
        assertEquals(Point.origo(), ropeMovement.getKnotPosition(2));
        assertEquals(List.of(Point.origo()), ropeMovement.getTailRoute());
    }
